...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO medicamentos(codigo,nombre,precio_compra,precio_venta,unidad,created_user,updated_user,stock) 
                                            VALUES('$codigo','$nombre','$pcompra','$pventa','$unidad','$created_user','$created_user','$stock')")
